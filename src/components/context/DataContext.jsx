...
const initialCategories = {
  revenue: [
    {
      ...
      subCategories: [
        ...
        {
          id: 'rev-sub-1-3',
          name: "Honoraires & chiffre d'affaires (BIC/BNC)",
        },
    ...
    {
      id: 'rev-main-3',
      name: 'PRESTATIONS DE SERVICES & ACTIVITÉS',
      isDefault: true,
      subCategories: [
    ...
    {
      id: 'rev-main-4',
      name: 'REVENUS FINANCIERS & DE PLACEMENTS',
      isDefault: true,
      subCategories: [
    ...
    {
      id: 'rev-main-5',
      name: 'AIDES, SUBVENTIONS & DOTATIONS',
      isDefault: true,
      subCategories: [
    ...
    {
      id: 'rev-main-7',
      name: 'REVENUS DIVERS & OCCASIONNELS',
      isDefault: true,
      subCategories: [
    ...
    {
      id: 'rev-main-8',
      name: 'FINANCEMENTS & CRÉDITS (Encaissements)',
      isDefault: true,
      subCategories: [
  ...
  expense: [
    {
      id: 'exp-main-1',
      name: 'RÉMUNÉRATIONS & HONORAIRES',
      isDefault: true,
      subCategories: [
        {
          id: 'exp-sub-1-1',
          name: 'Salaires, traitements et charges',
          criticality: 'critical',
        },
        {
          id: 'exp-sub-1-2',
          name: 'Honoraires (freelances, experts-comptables)',
          criticality: 'essential',
        },
        {
          id: 'exp-sub-1-3',
          name: 'Primes, bonus et participations',
          criticality: 'discretionary',
        },
        {
          id: 'exp-sub-1-4',
          name: 'Indemnités (déplacement, repas, km)',
          criticality: 'essential',
        },
        {
          id: 'exp-sub-1-5',
          name: 'Cotisations sociales personnelles',
          criticality: 'critical',
        },
      ],
    },
    {
      ...
      subCategories: [
        ...
        {
          id: 'exp-sub-2-2',
          name: 'Prêt immobilier (remboursement capital)',
          criticality: 'critical',
        },
        {
          id: 'exp-sub-2-3',
        ...
        {
          id: 'exp-sub-2-4',
          name: 'Entretien, réparations et amélioration',
          criticality: 'essential',
        },
        {
          id: 'exp-sub-2-5',
          name: 'Énergie (Électricité, Gaz, Chauffage)',
          criticality: 'critical',
        },
        {
          id: 'exp-sub-2-6',
        ...
        {
          id: 'exp-sub-2-7',
          name: 'Assurance habitation/locaux',
          criticality: 'critical',
        },
    ...
    },
    {
      ...
      subCategories: [
        {
          id: 'exp-sub-3-1',
          name: 'Carburant & Recharge',
          criticality: 'essential',
        },
        {
          id: 'exp-sub-3-2',
          name: 'Entretien, réparations et pièces',
          criticality: 'essential',
        },
        {
          id: 'exp-sub-3-3',
        ...
        {
          id: 'exp-sub-3-4',
          name: 'Péage, stationnement et amendes',
          criticality: 'discretionary',
        },
        {
          id: 'exp-sub-3-5',
        ...
        {
          id: 'exp-sub-3-6',
          name: 'Taxi, VTC, location de véhicule',
          criticality: 'discretionary',
        },
        {
          id: 'exp-sub-3-7',
          name: "Voyages longue distance (billets de train, d'avion)",
          criticality: 'discretionary',
        },
      ],
    },
    {
      ...
      subCategories: [
        ...
        {
          id: 'exp-sub-4-4',
          name: 'Repas en déplacement professionnel',
          criticality: 'essential',
        },
      ],
    },
    {
      id: 'exp-main-5',
      name: 'COMMUNICATION, INTERNET & ABONNEMENTS',
      isDefault: true,
      subCategories: [
        {
          id: 'exp-sub-5-1',
          name: 'Téléphonie mobile et fixe',
          criticality: 'essential',
        },
        {
          id: 'exp-sub-5-2',
          name: 'Internet (Box) et Abonnements TV',
          criticality: 'essential',
        },
        {
          id: 'exp-sub-5-3',
          name: 'Logiciels et applications (SaaS)',
          criticality: 'essential',
        },
        {
          id: 'exp-sub-5-4',
          name: 'Hébergement web, nom de domaine',
          criticality: 'essential',
        },
        {
          id: 'exp-sub-5-5',
          name: 'Équipements tech (ordinateur, smartphone)',
          criticality: 'discretionary',
        },
      ],
    },
    {
      id: 'exp-main-6',
      name: 'LOISIRS, CULTURE & SPORT',
      isDefault: true,
      subCategories: [
        {
          id: 'exp-sub-6-1',
          name: 'Abonnements culturels (Streaming, presse, jeux vidéo)',
          criticality: 'discretionary',
        },
        {
          id: 'exp-sub-6-2',
          name: 'Sports (Club, équipement, licence)',
          criticality: 'discretionary',
        },
        {
          id: 'exp-sub-6-3',
          name: 'Sorties (Cinéma, concert, musée, événement)',
          criticality: 'discretionary',
        },
        {
          id: 'exp-sub-6-4',
          name: 'Hobbies et passions',
          criticality: 'discretionary',
        },
        {
          id: 'exp-sub-6-5',
          name: 'Vacances et week-ends',
          criticality: 'discretionary',
        },
        {
          id: 'exp-sub-6-6',
          name: 'Cotisations associatives',
          criticality: 'discretionary',
        },
      ],
    },
    {
      ...
      subCategories: [
        ...
        {
          id: 'exp-sub-7-2',
          name: 'Frais médicaux (consultations, pharmacie)',
          criticality: 'essential',
        },
        {
          id: 'exp-sub-7-3',
          name: 'Soins (dentiste, opticien, kiné)',
          criticality: 'essential',
        },
        {
          id: 'exp-sub-7-4',
          name: 'Bien-être (Coaching, yoga, cosmétiques)',
          criticality: 'discretionary',
        },
      ],
    },
    {
      id: 'exp-main-8',
      name: 'PROJET IMMOBILIER & INVESTISSEMENTS',
      isDefault: true,
      subCategories: [
        {
          id: 'exp-sub-8-1',
        ...
        {
          id: 'exp-sub-8-3',
          name: "Travaux d'aménagement importants",
          criticality: 'discretionary',
        },
        {
          id: 'exp-sub-8-4',
          name: 'Achat de mobilier durable',
          criticality: 'discretionary',
        },
        {
          id: 'exp-sub-8-5',
    ...
    {
      id: 'exp-main-9',
      name: 'ACTIVITÉ PROFESSIONNELLE & ENTREPRISE',
      isDefault: true,
      subCategories: [
        {
          id: 'exp-sub-9-1',
        ...
        {
          id: 'exp-sub-9-2',
          name: 'Achat de marchandises / matières premières',
          criticality: 'essential',
        },
        { id: 'exp-sub-9-3', name: 'Sous-traitance', criticality: 'essential' },
        {
          id: 'exp-sub-9-4',
          name: 'Frais de déplacement professionnel (hors repas)',
          criticality: 'essential',
        },
        {
          id: 'exp-sub-9-5',
          name: 'Cotisations et frais professionnels',
          criticality: 'essential',
        },
        {
          id: 'exp-sub-9-6',
          name: 'Assurance responsabilité civile pro (RC Pro)',
          criticality: 'critical',
        },
        {
          id: 'exp-sub-9-7',
    ...
    {
      id: 'exp-main-11',
      name: 'IMPÔTS & CONTRIBUTIONS',
      isDefault: true,
      subCategories: [
        {
          id: 'exp-sub-11-1',
          name: 'Impôt sur le revenu / sur les sociétés',
          criticality: 'critical',
        },
        {
          id: 'exp-sub-11-2',
    ...
    },
    {
      ...
      subCategories: [
        {
          id: 'exp-sub-12-1',
          name: 'Frais de scolarité et garde',
          criticality: 'critical',
        },
        {
          id: 'exp-sub-12-2',
        ...
        {
          id: 'exp-sub-12-3',
          name: 'Vêtements et fournitures pour enfants',
          criticality: 'essential',
        },
      ],
    },
    {
      ...
      subCategories: [
        ...
        {
          id: 'exp-sub-13-2',
          name: 'Épargne retraite (PER)',
          criticality: 'discretionary',
        },
        {
          id: 'exp-sub-13-3',
          name: 'Frais divers et imprévus',
          criticality: 'essential',
        },
      ],
    },
    {
      id: 'exp-main-14',
      name: 'AMEUBLEMENT, ÉQUIPEMENT & DÉCORATION',
      isDefault: true,
      subCategories: [
        {
          id: 'exp-sub-14-1',
          name: 'Mobilier & Agencement',
          criticality: 'discretionary',
        },
        {
          id: 'exp-sub-14-2',
    ...
    {
      id: 'exp-main-15',
      name: 'FINANCEMENTS & CRÉDITS (Remboursements)',
      isDefault: true,
      subCategories: [
        {
          id: 'exp-sub-15-1',
        ...
        {
          id: 'exp-sub-15-2',
          name: 'Prêt investissement locatif',
          criticality: 'critical',
        },
  ...
  switch (action.type) {
    ...
    case 'SET_INITIAL_DATA': {
      ...
      customSubs.forEach((sub) => {
        let parent =
          finalCategories.revenue.find((m) => m.id === sub.parent_id) ||
          finalCategories.expense.find((m) => m.id === sub.parent_id);
        if (parent && !parent.subCategories.some((s) => s.id === sub.id)) {
          parent.subCategories.push({
            id: sub.id,
            name: sub.name,
            isFixed: sub.is_fixed,
            criticality: sub.criticality || 'essential',
          });
        }
      });
    ...
    case 'INITIALIZE_PROJECT_SUCCESS': {
      ...
      return {
        ...
        allCashAccounts: {
          ...state.allCashAccounts,
          [newProject.id]: finalCashAccounts,
        },
        tiers: newTiers,
      ...
      return {
        ...
        projects: state.projects.map((p) =>
          p.id === action.payload.projectId
            ? { ...p, ...action.payload.newSettings }
            : p
        ),
      };
    }
    case 'SAVE_ENTRY_SUCCESS': {
      const { savedEntry, newActuals, targetProjectId, newTier } =
        action.payload;
      const projectEntries = state.allEntries[targetProjectId] || [];
      const projectActuals = state.allActuals[targetProjectId] || [];
      const entryIndex = projectEntries.findIndex(
        (e) => e.id === savedEntry.id
      );
      const updatedEntries =
        entryIndex > -1
          ? projectEntries.map((e, i) => (i === entryIndex ? savedEntry : e))
          : [...projectEntries, savedEntry];
      const updatedActuals = projectActuals
        .filter(
          (a) =>
            a.budgetId !== savedEntry.id ||
            !['pending', 'partially_paid', 'partially_received'].includes(
              a.status
            )
        )
        .concat(newActuals);
    ...
    case 'DELETE_ENTRY_SUCCESS': {
      ...
      const projectEntries = (state.allEntries[entryProjectId] || []).filter(
        (e) => e.id !== entryId
      );
      const projectActuals = (state.allActuals[entryProjectId] || []).filter(
        (a) => a.budgetId !== entryId
      );
      return {
        ...state,
    ...
    case 'DELETE_PROJECT_SUCCESS': {
      ...
      const { [projectId]: ___, ...remainingCashAccounts } =
        state.allCashAccounts;
      return {
        ...state,
    ...
    case 'UPDATE_USER_CASH_ACCOUNT_SUCCESS': {
      ...
      const updatedAccounts = projectAccounts.map((acc) =>
    ...
    case 'ADD_USER_CASH_ACCOUNT_SUCCESS': {
      ...
      return {
        ...
        allCashAccounts: {
          ...state.allCashAccounts,
          [projectId]: [...projectAccounts, newAccount],
        },
      };
    }
    case 'DELETE_USER_CASH_ACCOUNT': {
      const { projectId, accountId } = action.payload;
      const projectAccounts = (state.allCashAccounts[projectId] || []).filter(
    ...
    case 'SAVE_ACTUAL_SUCCESS': {
      ...
      const actualIndex = projectActuals.findIndex(
        (a) => a.id === finalActualData.id
      );
      const updatedActuals =
        actualIndex > -1
          ? projectActuals.map((a, i) =>
              i === actualIndex ? finalActualData : a
            )
          : [...projectActuals, finalActualData];
      return {
        ...state,
    ...
    case 'DELETE_ACTUAL_SUCCESS': {
      ...
      for (const projectId in newAllActuals) {
        newAllActuals[projectId] = newAllActuals[projectId].filter(
          (a) => a.id !== actualId
        );
      }
    ...
    case 'WRITE_OFF_ACTUAL_SUCCESS': {
      ...
      const projectActuals = state.allActuals[projectId] || [];
      const updatedProjectActuals = projectActuals.map((a) =>
        a.id === updatedActual.id ? { ...a, ...updatedActual } : a
      );
      return {
        ...state,
        allActuals: { ...state.allActuals, [projectId]: updatedProjectActuals },
    ...
    case 'ADD_CONSOLIDATED_VIEW_SUCCESS':
      return {
        ...state,
        consolidatedViews: [...state.consolidatedViews, action.payload],
      };
    case 'UPDATE_CONSOLIDATED_VIEW_SUCCESS':
      return {
        ...state,
        consolidatedViews: state.consolidatedViews.map((v) =>
    ...
    case 'DELETE_CONSOLIDATED_VIEW_SUCCESS':
      return {
        ...state,
        consolidatedViews: state.consolidatedViews.filter(
    ...
    case 'UPDATE_PROFILE_NOTIFICATIONS':
      return {
        ...state,
        profile: { ...state.profile, notifications: action.payload },
      };
    ...
    case 'ARCHIVE_SCENARIO':
      return {
        ...state,
        scenarios: state.scenarios.map((s) =>
          s.id === action.payload ? { ...s, isArchived: true } : s
        ),
      };
    case 'RESTORE_SCENARIO':
      return {
        ...state,
        scenarios: state.scenarios.map((s) =>
          s.id === action.payload ? { ...s, isArchived: false } : s
        ),
      };
    case 'SAVE_SCENARIO_ENTRY_SUCCESS': {
      ...
      const entryIndex = scenarioDeltas.findIndex(
        (e) => e.id === savedEntry.id
      );
      const updatedDeltas =
        entryIndex > -1
          ? scenarioDeltas.map((e, i) => (i === entryIndex ? savedEntry : e))
          : [...scenarioDeltas, savedEntry];
      return {
        ...state,
        scenarioEntries: {
          ...state.scenarioEntries,
          [scenarioId]: updatedDeltas,
        },
      };
    }
    case 'DELETE_SCENARIO_ENTRY_SUCCESS': {
      ...
      const scenarioDeltas = state.scenarioEntries[scenarioId] || [];
      const updatedDeltas = scenarioDeltas.map((e) =>
    ...
    case 'ADD_SUB_CATEGORY_SUCCESS': {
      ...
      const mainCatIndex = newCategories[type].findIndex(
    ...
    case 'SAVE_TAX_CONFIG_SUCCESS': {
      ...
      const existingIndex = state.taxConfigs.findIndex(
        (tc) => tc.id === newConfig.id
      );
      let newTaxConfigs;
      if (existingIndex > -1) {
        newTaxConfigs = state.taxConfigs.map((tc, i) =>
          i === existingIndex ? newConfig : tc
        );
      } else {
    ...
    case 'DELETE_TAX_CONFIG_SUCCESS': {
      return {
        ...state,
        taxConfigs: state.taxConfigs.filter((tc) => tc.id !== action.payload),
      };
    }
    case 'ADD_TIER': {
    ...
    case 'DELETE_TIER': {
      return {
        ...state,
        tiers: state.tiers.filter((t) => t.id !== action.payload),
      };
    }

...
const DashboardView = () => {
  ...
  const [isSettingsDrawerOpen, setIsSettingsDrawerOpen] = useState(false); // MODIFIÉ

  const handleOpenSettings = () => {
    setIsSettingsDrawerOpen(true); // MODIFIÉ
  };
  ...
  const handleSaveSettings = (newSettings) => {
    ...
    if (activeProject && !isConsolidated) {
      ...
      // dataDispatch({ type: 'UPDATE_PROJECT_SETTINGS', payload: { dashboard_widgets: newSettings } });
    }
    
    setIsSettingsDrawerOpen(false); // MODIFIÉ
    uiDispatch({ 
      type: 'ADD_TOAST', 
      payload: { 

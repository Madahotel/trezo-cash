              ...
              widgetVisibility[kpi.id] && (
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`bg-white p-3 rounded-xl shadow-md group-hover:scale-110 transition-transform duration-300`}
                    >
                        ...
                        >
                          <div className="flex justify-between items-center">
                            <div className="flex items-center gap-3">
                              <div
                                className={`flex-shrink-0 flex items-center justify-center w-8 h-8 rounded-lg shadow-sm ${
                                  item.type === "payable"
                                    ? "bg-red-100"
                                    : "bg-green-100"
                                }`}
                            ...
                            <p
                              className={`text-base font-semibold whitespace-nowrap pl-2 ${
                                item.type === "payable"
                                  ? "text-red-600"
                                  : "text-green-600"
                              }`}

  ...
  return (
    <Card
      className={`relative transition-all duration-200 hover:shadow-lg ${
        ...
        isActiveProject
          ? 'ring-2 ring-green-500 border-green-200 shadow-md'
          : ''
      }`}
    >
      ...
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          <div className="flex items-center space-x-3 flex-1 min-w-0">
            <div
              className={`w-12 h-12 rounded-xl ${currentColor.bg} flex items-center justify-center flex-shrink-0 shadow-sm`}
            >
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center">
                      ...
                      />
                      <label
                        htmlFor="edit-duration-indetermined"
          ...
          <div className="p-3 bg-gradient-to-br from-blue-50 to-blue-25 rounded-xl border border-blue-100">
            ...
            <div className="flex justify-between items-center">
              <div className="text-center">
                ...
                <p
                  className={`text-sm font-bold ${
                    netBudget >= 0 ? 'text-green-600' : 'text-red-500'
                  }`}
                >
                  {budgetLoading ? (
              ...
              <div className="text-center">
                ...
                <p
                  className={`text-sm font-bold ${
                    netRealized >= 0 ? 'text-green-600' : 'text-red-500'
                  }`}
                >
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  setEditForm({
                    ...project,
                    isDurationUndetermined:
                      project.isDurationUndetermined || !project.endDate,
                  });
                }}
              >

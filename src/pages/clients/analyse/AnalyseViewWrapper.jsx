...
import ConsolidatedAnalyseView from './ConsolidatedAnalyseView';
 

const AnalyseViewWrapper = () => {
  const { uiState } = useUI();
  
  const activeProject = uiState.activeProject;

  // Déterminer le mode d'affichage basé sur le projet actif
  ...
  if (displayMode.type === 'consolidated') {
          ...
          <div className="max-w-4xl mx-auto">
            <div className="mb-6">
              <h1 className="text-2xl font-semibold text-gray-900">
                Analyse consolidée - {displayMode.projectName}
              </h1>
            ...
            <div className="p-8 text-center border-2 border-gray-300 border-dashed rounded-lg">
              <div className="flex flex-col items-center">
                ...
                <h3 className="mb-2 text-lg font-medium text-gray-900">
                  Analyse consolidée globale
                </h3>
                <p className="mb-4 text-gray-600">
                  Tous vos projets combinés dans une vue d'analyse unique
                </p>
                <div className="grid w-full max-w-md grid-cols-2 gap-4">
                  <div className="p-3 rounded-lg bg-green-50">
                    <div className="text-sm font-medium text-green-700">Revenus consolidés</div>
                    <div className="text-lg font-bold text-green-800">Analyse combinée</div>
                  </div>
                  <div className="p-3 rounded-lg bg-red-50">
                    <div className="text-sm font-medium text-red-700">Dépenses consolidées</div>
                    <div className="text-lg font-bold text-red-800">Analyse combinée</div>
                  </div>
                </div>
              </div>
            </div>
    ...
    return <ConsolidatedAnalyseView consolidationId={displayMode.consolidationId} />;
  }
...
export default AnalyseViewWrapper;
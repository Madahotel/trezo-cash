...
const BudgetTableView = (props) => {
  ...
  //           Array.isArray(res.collection) && res.collection.length > 0;
  ...
  //           if (
  //             res.budget &&
  //             res.budget.budget_detail_id &&
  //             res.budget.budget_detail_id !== budgetId
  //           ) {
  ...
  //     } catch (error) {
  //       console.warn(
  //         `⚠️ Erreur fetch collection ${budgetId}, utilisation des données par défaut:`,
  //         error
  //       );
  ...
  //         processedBudgetEntries.length > 0 &&
  //         periods &&
  //         periods.length > 0
  //       ) {
